...
//1. GET a random joke
// i just put te res.json(jokes); with out the random number bc i tought 
// i cants use that way to make random choices, i did that at the 
// begining of the course lol fuck
...
app.get("/filter", (req, res) => {
  ...
  if (filterType) {
    const matches = jokes.filter(item => item.jokeType.includes(filterType));
    res.json(matches);
  }
});
